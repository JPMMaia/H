...
namespace h
{
    void test_validate_module(
        ...
        std::span<std::pmr::string const> const input_dependencies_text,
...
var my_global_1: Int32 = 2.0f32;
        ...
        std::pmr::vector<Diagnostic> expected_diagnostics = {
            {
...
struct My_struct
{
    a: Int32 = 0;
        ...
        test_validate_module(input, [test_b_input], expected_diagnostics);
    }
...
import module_b as module_a;
        ...
        test_validate_module(input, [module_a_input, module_b_input], expected_diagnostics);
    }
...
union My_union
{
    ...
    b: Float32;
        ...
        test_validate_module(input, [test_2_input], expected_diagnostics);
    }
...
function run(int_input: Int32, enum_input: dependency.My_enum) -> ()
{
    ...
    var value_2 = int_input as dependency.My_struct;
        ...
        test_validate_module(input, [dependency], expected_diagnostics);
    }
}