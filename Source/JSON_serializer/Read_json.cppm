...
namespace h::json
{
        ...
        )
    {
        ...
        case 2:
        {
            std::cerr << "While parsing 'Integer_constant' unexpected '}' found.\n";
            return false;
        }
        case 3:
        {
        ...
        std::cerr << "Error while reading 'Integer_constant'.\n";
        return false;
    }
        ...
        )
    {
        ...
        case 2:
        {
            std::cerr << "While parsing 'Half_constant' unexpected '}' found.\n";
            return false;
        }
        case 3:
        {
        ...
        )
    {
        ...
        case 2:
        {
            std::cerr << "While parsing 'Float_constant' unexpected '}' found.\n";
            return false;
        }
        case 3:
        {
        ...
        std::cerr << "Error while reading 'Float_constant'.\n";
        return false;
    }
        ...
        )
    {
        ...
        case 2:
        {
            std::cerr << "While parsing 'Double_constant' unexpected '}' found.\n";
            return false;
        }
        case 3:
        {
        ...
        )
    {
        ...
        case 1:
        {
            ...
            case Event::Key:
            {
                if constexpr (std::is_same_v<Event_data, std::string_view>)
                {
                    ...
                    else if (event_data == "integer_constant")
                    {
                        output.data = Integer_constant{};
                        state = 5;
                        return true;
                    }
                    else if (event_data == "half_constant")
                    {
                        output.data = Half_constant{};
                        state = 7;
                        return true;
                    }
                    else if (event_data == "float_constant")
                    {
                        output.data = Float_constant{};
                        state = 9;
                        return true;
                    }
                    else if (event_data == "double_constant")
                    {
                        output.data = Double_constant{};
                        state = 11;
                        return true;
                    }
                }
        ...
        {
            state = 4;
            return read_object(output.type, event, event_data, state_stack, state_stack_position + 1);
        }
        case 4:
        {
            if ((event == Event::End_object) && (state_stack_position + 2 == state_stack.size()))
            {
                if (!read_object(output.type, event, event_data, state_stack, state_stack_position + 1))
                {
                    return false;
                }
        ...
        {
            state = 6;
            return read_object(std::get<Integer_constant>(output.data), event, event_data, state_stack, state_stack_position + 1);
        }
        case 6:
        {
            if ((event == Event::End_object) && (state_stack_position + 2 == state_stack.size()))
            {
                if (!read_object(std::get<Integer_constant>(output.data), event, event_data, state_stack, state_stack_position + 1))
                {
                    return false;
                }
        ...
        {
            state = 8;
            return read_object(std::get<Half_constant>(output.data), event, event_data, state_stack, state_stack_position + 1);
        }
        case 8:
        {
            if ((event == Event::End_object) && (state_stack_position + 2 == state_stack.size()))
            {
                if (!read_object(std::get<Half_constant>(output.data), event, event_data, state_stack, state_stack_position + 1))
                {
                    return false;
                }
        ...
        {
            state = 10;
            return read_object(std::get<Float_constant>(output.data), event, event_data, state_stack, state_stack_position + 1);
        }
        case 10:
        {
            if ((event == Event::End_object) && (state_stack_position + 2 == state_stack.size()))
            {
                if (!read_object(std::get<Float_constant>(output.data), event, event_data, state_stack, state_stack_position + 1))
                {
                    return false;
                }
        ...
        {
            state = 12;
            return read_object(std::get<Double_constant>(output.data), event, event_data, state_stack, state_stack_position + 1);
        }
        case 12:
        {
            if ((event == Event::End_object) && (state_stack_position + 2 == state_stack.size()))
            {
                if (!read_object(std::get<Double_constant>(output.data), event, event_data, state_stack, state_stack_position + 1))
                {
                    return false;
                }
