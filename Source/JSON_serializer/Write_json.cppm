...
namespace h::json
{
    ...
    {
        writer.StartObject();
        if (std::holds_alternative<Float_type>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Float_type>(output.data));
        }
        else if (std::holds_alternative<Integer_type>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Integer_type>(output.data));
        }
        writer.EndObject();
    }
        ...
        )
    {
        ...
        {
            writer.Key("data");
            write_object(writer, std::get<Integer_constant>(output.data));
        }
        else if (std::holds_alternative<Half_constant>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Half_constant>(output.data));
        }
        else if (std::holds_alternative<Float_constant>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Float_constant>(output.data));
        }
        else if (std::holds_alternative<Double_constant>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Double_constant>(output.data));
        }
        writer.EndObject();
    }
        ...
        )
    {
        ...
        {
            writer.Key("data");
            write_object(writer, std::get<Binary_expression>(output.data));
        }
        else if (std::holds_alternative<Call_expression>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Call_expression>(output.data));
        }
        else if (std::holds_alternative<Constant_expression>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Constant_expression>(output.data));
        }
        else if (std::holds_alternative<Return_expression>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Return_expression>(output.data));
        }
        else if (std::holds_alternative<Variable_expression>(output.data))
        {
            writer.Key("data");
            write_object(writer, std::get<Variable_expression>(output.data));
        }
        writer.EndObject();
    }
