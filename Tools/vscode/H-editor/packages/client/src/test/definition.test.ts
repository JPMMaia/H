...
suite("Should get definition location of structs", () => {
    ...
    test.skip("Gets definition location of struct as a function input parameter type", async () => {
        const document_uri = get_document_uri("definition_struct_0.hltxt");
    ...
    test.skip("Gets definition location of struct as a function output parameter type", async () => {
        const document_uri = get_document_uri("definition_struct_0.hltxt");
    ...
    test.skip("Gets definition location of struct as a variable declaration type", async () => {
        const document_uri = get_document_uri("definition_struct_0.hltxt");
    ...
    test.skip("Gets definition location of struct member 0 at instantiate expression", async () => {
    ...
    test.skip("Gets definition location of struct member 1 at instantiate expression", async () => {
        const document_uri = get_document_uri("definition_struct_1.hltxt");
    ...
    test.skip("Gets definition location of struct member 2 at instantiate expression", async () => {
    ...
    test.skip("Gets definition location of struct member at access expression 0", async () => {
    ...
    test.skip("Gets definition location of struct member at access expression 1", async () => {
        const document_uri = get_document_uri("definition_struct_3.hltxt");
    ...
    test.skip("Gets definition location of struct member at access expression 2", async () => {
        const document_uri = get_document_uri("definition_struct_3.hltxt");
...
suite("Should get definition location of unions", () => {
    ...
    test.skip("Gets definition location of union as a function input parameter type", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union as a function output parameter type", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union as a variable declaration type", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at instantiate expression 0", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at instantiate expression 1", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at instantiate expression 2", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at instantiate expression 3", async () => {
    ...
    test.skip("Gets definition location of union member at instantiate expression 4", async () => {
        const document_uri = get_document_uri("definition_union_1.hltxt");
    ...
    test.skip("Gets definition location of union member at access expression 0", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at access expression 1", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
    ...
    test.skip("Gets definition location of union member at access expression 2", async () => {
        const document_uri = get_document_uri("definition_union_0.hltxt");
...
suite("Should get definition location of functions", () => {
    ...
    test.skip("Gets definition location of function name 0", async () => {
    ...
    test.skip("Gets definition location of function name 1", async () => {
...
suite("Should get definition location of enums", () => {
    ...
    test.skip("Gets definition location of enum at function input parameter type", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum at function output parameter type", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum at access expression 0", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum at access expression 1", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum at access expression 2", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum value 0", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum value 1", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
    ...
    test.skip("Gets definition location of enum value 2", async () => {
        const document_uri = get_document_uri("definition_enum_0.hltxt");
        await test_definitions(document_uri, new vscode.Position(13, 23), [
...
suite("Should get definition location of global variables", () => {
    ...
    test.skip("Gets definition location of global variable when used as expression", async () => {
        const document_uri = get_document_uri("definition_global_variable_0.hltxt");
    ...
    test.skip("Gets definition location of define when used as expression", async () => {
