...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Declaration -> Comment_or_empty Global_variable",
        ...
        "Global_variable -> Export Global_variable_mutability Global_variable_name Global_variable_type = Generic_expression_or_instantiate ;",
