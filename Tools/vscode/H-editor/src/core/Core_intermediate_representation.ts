...
export function create_if_expression(series: Condition_expression_pair[]): Expression {
...
export function create_while_loop_expression(condition: Expression, then_expression: Expression): Expression {
