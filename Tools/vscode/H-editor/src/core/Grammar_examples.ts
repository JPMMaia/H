...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Expression_level_0 -> Expression_constant | Expression_instantiate_struct | Expression_null_pointer | Expression_variable | Expression_parenthesis",
        ...
        "Expression_for_loop -> for Expression_for_loop_variable in Expression_for_loop_range_begin to Expression_for_loop_range_end Expression_for_loop_step Expression_for_loop_reverse : Statement",
        ...
        "Expression_instantiate_struct -> Expression_instantiate_struct_type Expression_instantiate_struct_name { Expression_instantiate_struct_members }",
        "Expression_instantiate_struct_name -> ",
        "Expression_instantiate_struct_name -> Type",
        "Expression_instantiate_struct_type -> default",
        "Expression_instantiate_struct_type -> explicit",
        "Expression_instantiate_struct_members -> Expression_instantiate_struct_member , $0_or_more",
        "Expression_instantiate_struct_member -> Expression_instantiate_struct_member_name : Generic_expression",
        "Expression_instantiate_struct_member_name -> identifier",
        ...
        "Expression_variable_declaration_with_type -> Expression_variable_mutability Variable_name : Expression_variable_declaration_type = Generic_expression",
