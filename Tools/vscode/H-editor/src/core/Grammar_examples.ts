...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Generic_expression -> Expression_unary",
        ...
        "Expression_binary_symbol -> + | - | * | / | % | == | != | < | <= | > | >= | && | || | & | $single_or | ^ | << | >>",
        "Expression_return -> return",
        "Expression_return -> return Generic_expression",
        "Expression_unary -> Expression_unary_previous | Expression_unary_after",
        "Expression_unary_previous -> Expression_unary_previous_symbol Generic_expression",
        "Expression_unary_previous_symbol -> ! | ~ | - | ++ | -- | & | *",
        "Expression_unary_after -> Generic_expression Expression_unary_after_symbol",
        "Expression_unary_after_symbol -> ++ | --",
