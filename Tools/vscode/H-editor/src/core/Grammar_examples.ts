...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Declaration -> Comment_or_empty Alias",
        "Declaration -> Comment_or_empty Enum",
        "Declaration -> Comment_or_empty Struct",
        "Declaration -> Comment_or_empty Union",
        "Declaration -> Comment_or_empty Function",
        "Export -> ",
        "Export -> export",
