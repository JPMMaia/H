...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Generic_expression -> Expression_binary_logical_or | Expression_level_11",
        ...
        "Expression_binary_logical_or -> Generic_expression Expression_binary_logical_or_symbol Expression_level_11",
