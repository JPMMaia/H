...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Expression_level_0 -> Expression_constant | Expression_null_pointer | Expression_variable | Expression_parenthesis",
        ...
        "Expression_instantiate_struct -> Expression_instantiate_struct_type {  }",
        "Expression_instantiate_struct_type -> ",
