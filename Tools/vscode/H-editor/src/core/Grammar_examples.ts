...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Expression_level_0 -> Expression_constant | Expression_instantiate | Expression_null_pointer | Expression_variable | Expression_parenthesis",
        ...
        "Expression_instantiate -> Expression_instantiate_expression_type Expression_instantiate_name { Expression_instantiate_members }",
        "Expression_instantiate_name -> ",
        "Expression_instantiate_name -> Type",
        "Expression_instantiate_expression_type -> default",
        "Expression_instantiate_expression_type -> explicit",
        "Expression_instantiate_members -> Expression_instantiate_member , $0_or_more",
        "Expression_instantiate_member -> Expression_instantiate_member_name : Generic_expression",
