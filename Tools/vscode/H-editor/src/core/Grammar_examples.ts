...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Struct_member -> Struct_member_name : Struct_member_type = Generic_expression_or_instantiate ;",
        ...
        "Expression_level_2 -> Expression_cast | Expression_unary_1 | Expression_level_1",
        ...
        "Expression_for_loop -> for Expression_for_loop_variable in Expression_for_loop_range_begin to Expression_for_loop_range_end Expression_for_loop_step Expression_for_loop_reverse { Expression_for_loop_statements }",
