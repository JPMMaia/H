...
export function create_test_grammar_9_description(): string[] {
    return [
        ...
        "Expression_for_loop -> for Expression_for_loop_variable in Expression_for_loop_range_begin to Expression_for_loop_range_end Expression_for_loop_step : Generic_expression",
        ...
        "Expression_for_loop_step -> step_by Expression_for_loop_step_value",
        "Expression_for_loop_step_value -> Expression_for_loop_number_expression",
        ...
        "Expression_if -> if Generic_expression : Generic_expression Expression_if_else",
        "Expression_if_else -> ",
        "Expression_if_else -> else Expression_if",
        "Expression_if_else -> else Generic_expression",
        ...
        "Expression_ternary_condition -> Generic_expression ? Expression_level_12 : Expression_level_12",
