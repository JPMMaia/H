...
function is_same_position(first: number[], second: number[]): boolean {
...
function get_parent_position(position: number[]): number[] {
...
function get_rightmost_brother(root: Node, position: number[]): { node: Node, position: number[] } {
...
function have_same_parent(node_positions: number[][]): boolean {
...
function get_rightmost_descendant(node: Node, position: number[]): { node: Node, position: number[] } {
    if (node.children.length === 0) {
        return {
            node: node,
            position: position
