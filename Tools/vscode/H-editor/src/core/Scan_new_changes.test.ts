...
function create_parse_node(value: string, children: Node[], production_rule_index?: number): Node {
    return {
        word: { value: value, type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 },
        state: -1,
...
describe("Scan_new_changes.get_text_before_start", () => {
    it("Cuts the word", () => {
        ...
        const value = get_text_before_start(2, iterator);
    ...
    it("Returns the whole word", () => {
        ...
        const text = "module";
        const iterator = Parse_tree_text_iterator.begin(node, text);
        const value = get_text_before_start(6, iterator);
        assert.equal(value, "module");
    });

    it("Adds space at the end", () => {
        const node = create_parse_node("module", []);
        const text = "module";
        const iterator = Parse_tree_text_iterator.begin(node, text);
        const value = get_text_before_start(9, iterator);
        assert.equal(value, "module ");
    });
});
...
describe("Scan_new_changes.scan_new_change", () => {
    it("Scans change 0", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "module", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
    ...
    it("Scans change 1", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "mo", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }, { value: "dule", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
            assert.equal(result.after_change.node, undefined);
        }
    ...
    it("Scans change 3", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "mode", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
            assert.equal(result.after_change.node, undefined);
        }
    ...
    it("Scans change 4", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "model", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
            assert.equal(result.after_change.node, undefined);
        }
    ...
    it("Scans change 5", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "nome", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
    ...
    it("Scans change 6", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "modulename", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
            assert.deepEqual(result.after_change.node_position, [2]);
        }
    ...
    it("Scans change 7", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "name_", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
            assert.deepEqual(result.after_change.node_position, [2]);
        }
    ...
    it("Scans change 8", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "_export", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
    ...
    it("Scans change 9", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "_struct", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
    ...
    it("Scans change 11", () => {
        ...
        assert.deepEqual(result.new_words, [{ value: "another", type: Grammar.Word_type.Alphanumeric, comments: [], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
    ...
    it("Scans change with comments", () => {
        ...
        assert.notEqual(result.start_change, undefined);
        if (result.start_change !== undefined) {
            assert.deepEqual(result.start_change.node_position, []);
        }
        assert.deepEqual(result.new_words, [{ value: "module", type: Grammar.Word_type.Alphanumeric, comments: ["A comment", "Another comment"], newlines_after: 0 }]);
        assert.notEqual(result.after_change, undefined);
        if (result.after_change !== undefined) {
