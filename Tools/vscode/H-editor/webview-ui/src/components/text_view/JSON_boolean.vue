...
const emit = defineEmits<{
    (e: 'update', new_value: boolean): void
}>();
...
<template>
    <Search_field :possible_values="get_boolean_possible_values()" :current_search_term="properties.value.toString()"
        v-on:update="on_boolean_selected">
    </Search_field>
</template>
